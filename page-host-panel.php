 ...
 * 
 * The secure frontend dashboard for homestay hosts to manage their listings,
 * bookings, calendar, and payouts.
 *
...
<div class="hhb-dashboard-wrapper" style="background-color: #f8fafc; min-height: 100vh; display: flex; font-family: 'Inter', sans-serif;">
    ...
    <aside class="hhb-dashboard-sidebar" style="width: 260px; background: #ffffff; border-right: 1px solid #e2e8f0; padding: 24px 0; display: flex; flex-direction: column;">
        ...
        <div style="padding: 24px 16px; border-top: 1px solid #e2e8f0; margin-top: auto;">
            <a href="<?php echo wp_logout_url( home_url() ); ?>" style="display: flex; items-center; padding: 12px 16px; color: #ef4444; text-decoration: none; border-radius: 8px; transition: all 0.2s; hover:background: #fef2f2;">
    ...
    <main class="hhb-dashboard-main" style="flex: 1; padding: 40px; overflow-y: auto;">
        ...
        <div class="hhb-dashboard-content">
            <?php 
                // We will require separate PHP files for each view to keep the code organized.
                // For now, we put placeholder files.
                $view_file = get_template_directory() . "/template-parts/host-dashboard/view-{$current_view}.php";
...
<?php 
// Optional: Hide default theme footer on this dashboard if desired.
// get_footer(); 
wp_footer(); 
?>
</body>
