<?php
/**
 * Footer Layout: 4-Column Footer
 *
 * A footer layout consisting of:
 * - Main Footer: 4 columns (About, Menu 1, Menu 2, Contact)
 * - Copyright Bar: Bottom section with copyright text
 *
 * Layout ID: 4-column
 *
