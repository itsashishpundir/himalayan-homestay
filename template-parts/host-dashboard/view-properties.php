<?php
/**
 * Host Dashboard — My Properties View
 *
 * Displays a list of all homestays owned by the logged-in user,
 * styled according to the Stitch "Table View" mockup.
 *
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: right;">
                    ...
                    <button class="button button-secondary hhb-delete-property" data-id="<?php echo esc_attr( $post->ID ); ?>" style="display: inline-flex; align-items: center; gap: 6px; border: 1px solid #fee2e2; background: #fef2f2; padding: 6px 12px; border-radius: 6px; color: #dc2626; text-decoration: none; font-size: 13px; font-weight: 600; cursor: pointer;">
...
document.addEventListener('DOMContentLoaded', function() {
    const deleteBtns = document.querySelectorAll('.hhb-delete-property');
